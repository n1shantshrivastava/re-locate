...
//        console.log('displayObjects method called');
    ...
    function attachObject(objectId, object_image_html,object_url_html) {
        var $object = $('<div class="object draggableObjects draggableObjects-android" >'+object_image_html+object_url_html+'</div>');
...
//            alert('dropable called')
    ...
    $(".smallCircle-android").click(function(){
        ...
        $('.circleBox-android').masonry('remove',$('.object')).masonry('reload');

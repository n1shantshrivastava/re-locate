...
//        console.log('displayObjects method called');
    ...
    function attachObject(objectId, object_image_html,object_url_html) {
        var $object = $('<div class="object draggableObjects draggableObjects-business-analyst" >'+object_image_html+object_url_html+'</div>');
...
//            alert('dropable called')
    ...
    $(".smallCircle-business-analyst").click(function(){
        ...
        $('.circleBox-business-analyst').masonry('remove',$('.object')).masonry('reload');

...
//        console.log('displayObjects method called');
    ...
    function attachObject(objectId, object_image_html,object_url_html) {
        var $object = $('<div class="object draggableObjects draggableObjects-quality-analyst" >'+object_image_html+object_url_html+'</div>');
...
//            alert('dropable called')
    ...
    $(".smallCircle-quality-analyst").click(function(){
        ...
        $('.circleBox-quality-analyst').masonry('remove',$('.object')).masonry('reload');
